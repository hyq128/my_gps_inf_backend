...
class experimentAdmin(admin.ModelAdmin):
    fields = ( 'start_time','end_time','exp_name','description',"acc_frequency","bt_frequency","gps_frequency","participants_name",)
    list_display = ('exp_id','exp_name','description','start_time','end_time',"acc_frequency","bt_frequency","gps_frequency","participants_name",)
    list_per_page = 10
